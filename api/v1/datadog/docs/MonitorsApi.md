...
func main() {
    ...
    withDowntimes := true // bool | If this argument is set to true, then the returned data includes all current in progress downtimes for each monitor. (optional)
...
**withDowntimes** | **bool** | If this argument is set to true, then the returned data includes all current in progress downtimes for each monitor. | 
